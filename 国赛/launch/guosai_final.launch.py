    ...
    actions.append(
        _py_node(
            ...
            "nodes/localization_watchdog.py",
            {
                ...
                "ground_plane": slam.get("ground_plane", "xz"),
                "forward_axis": slam.get("forward_axis", "z"),
    ...
    actions.append(
        _py_node(
            ...
            "nodes/waypoint_navigator.py",
            {
                ...
                "ground_plane": nav.get("ground_plane", "xz"),
                "forward_axis": nav.get("forward_axis", "z"),
                "turn_sign": nav.get("turn_sign", 1.0),
            },
            "waypoint_navigator",
        )
    )
        ...
        actions += [
            _py_node(
                ...
                "nodes/cone_avoidance_node.py",
                {
                    ...
                    "ground_plane": cone.get("ground_plane", "xz"),
                    "forward_axis": cone.get("forward_axis", "z"),
                },
                "cone_avoidance_node",
            ),
            _shell_process(
